  ...
  implicit class WithByModule(m: ModuleID) {
    ...
    object excludes {
      ...
      def log4j: ModuleID = m
        ...
        .exclude(org = "commons-logging", name = matchAll)
